...
class UserChangePasswordView(LoginRequiredMixin, FormView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['old_password'].widget.attrs['placeholder']='Ingrese su contraseña atual'
        form.fields['new_password1'].widget.attrs['placeholder']='Ingrese su nueva contraseña'
        form.fields['new_password2'].widget.attrs['placeholder']='Repite su nueva contraseña'
